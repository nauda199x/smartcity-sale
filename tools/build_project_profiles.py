...
<footer class="footer"><div class="shell"><p>Sàn Smart City · Cổng thông tin độc lập dành cho người mua. <a href="/gia-ban-vinhomes-smart-city.html">Cách đọc dữ liệu giá</a>.</p></div></footer><script src="/assets/app-shell.js" defer></script></body></html>'''
